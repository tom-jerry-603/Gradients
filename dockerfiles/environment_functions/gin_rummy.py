def rollout_first_prompt_and_completion(prompts: list[str], trainer, max_turns: int = 30) -> dict[str, list]:
    ...
    if not getattr(rollout_first_prompt_and_completion, "initialized", False):
        ...
        try:
            ...
            rollout_first_prompt_and_completion.mcts_simulations = 1
    ...
    for i, prompt in enumerate(prompts):
        ...
        payload = {"task_id": game_id, "seed": game_id, "opponent": "mcts", "mcts_max_simulations": rollout_first_prompt_and_completion.mcts_simulations, "mcts_num_rollouts": 1}
